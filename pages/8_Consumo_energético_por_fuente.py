...
with col1:
    ...
    st.download_button("📄 Descargar CSV (filtro actual)", data=csv,
                       file_name="consumo_energetico_global_filtrado.csv", mime="text/csv")
with col2:
    buffer = BytesIO()
    fig.write_image(buffer, format="png")
    st.download_button("🖼️ Descargar gráfico principal (PNG)", data=buffer,
                       file_name="grafico_consumo_energetico_global.png", mime="image/png")
